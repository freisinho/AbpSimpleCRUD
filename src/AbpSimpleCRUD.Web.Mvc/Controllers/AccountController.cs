...
using AbpSimpleCRUD.Web.Models.Account;
using AbpSimpleCRUD.Web.Views.Shared.Components.TenantChange;

namespace AbpSimpleCRUD.Web.Controllers
{
    public class AccountController : AbpSimpleCRUDControllerBase
    {
